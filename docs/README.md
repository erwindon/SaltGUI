...
SaltGUI is an open source web interface for managing a SaltStack server and its minions. Built using plain ES2025 and implemented as a wrapper around the rest_cherrypy server a.k.a. salt-api.
