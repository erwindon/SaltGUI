...
This can either be through a pull-request (PR) or by creating an issue with an idea/problem/question.
...
When you create an issue with an problem, make sure that:
* it is one problem/question at a time

When you create a PR, make sure that:
* it is one idea/fix at a time
* a fix describes the problem that is solved
...
Contributors are responsible for understanding every line they submit including the code, the commit messages and the issue/pr descriptions.
All of the above rules apply equally to AI-assisted contributions.
