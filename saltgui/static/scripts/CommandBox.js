...
export class CommandBox {
  ...
  static _showHelp () {
    ...
    txt += "<p>Entries that contain a @, (, ) or space are assumed to be a compound target selection. See <a href='https://docs.saltstack.com/en/latest/topics/targeting/#compound-targeting' target='_blank' rel='noopener'>Compound Targeting<img src='static/images/externallink.png' width='12px'></a>.";
    txt += "<br/>Entries that contain a COMMA are assumed to be a list target selection. See <a href='https://docs.saltstack.com/en/latest/topics/targeting/globbing.html#lists' target='_blank' rel='noopener'>List Targeting<img src='static/images/externallink.png' width='12px'></a>.";
    txt += "<br/>Entries that start with a # are assumed to be a nodegroup target selection. See <a href='https://docs.saltstack.com/en/latest/topics/targeting/nodegroups.html' target='_blank' rel='noopener'>Nodegroup Targeting<img src='static/images/externallink.png' width='12px'></a>.";
    txt += "<br/>Otherwise, the target is assumed to be a regular glob selection. See <a href='https://docs.saltstack.com/en/latest/topics/targeting/globbing.html#globbing' target='_blank' rel='noopener'>Globbing Targeting<img src='static/images/externallink.png' width='12px'></a>.";
