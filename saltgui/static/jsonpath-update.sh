...
wget --max-redirect=0 -O jsonpath/jsonpath-$VERSION.js https://storage.googleapis.com/google-code-archive-downloads/v2/code.google.com/jsonpath/jsonpath-$VERSION.js.txt
sed --in-place \
	-e 's/\[0-9\]/\\d/g' \
	-e 's/\[0-9\*\]/[\\d*]/g' \
